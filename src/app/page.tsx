      ...
      <section className="pt-10 pb-10" id="features">
        ...
        <div className="grid grid-cols-1  grid-rows-[500px_1fr] lg:grid-rows-1 lg:grid-cols-2 gap-3 max-w-[1200px] m-auto p-4">
          ...
          <div className="flex flex-col justify-start gap-6 items-start w-full text-[18px]">
            <p>
              Многие откладывают мечту о красивых губах из-за пугающих фото в интернете или историй о неудачной
              контурной пластике. Важно понимать: подобные результаты – чаще всего следствие: отсутствия врачебного
              подхода, нарушения техники, игнорирования индивидуальности. В моей практике приоритеты иные: вы можете
              быть уверены, что не станете обладателем «утиных губ». Моя цель – гармоничный, свежий, естественный вид.
              &quot;Больше&quot; – не значит &quot;лучше&quot;.
            </p>
            <p>
              На предварительной консультации я подбираю необходимый препарат и объем, исходя из ваших пожеланий и
              анатомии лица. Поэтому не стоит отказываться от мечты из-за чужих негативных примеров. Красивые, здоровые
              губы – это реальность, достижимая благодаря профессионализму и индивидуальному подходу.
            </p>
            <ButtomOpenModal>Записаться на прием</ButtomOpenModal>
          </div>
        </div>
