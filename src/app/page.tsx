    ...
    <>
      ...
      <section className="pt-10 pb-10" id="features">
        ...
        <div className="grid grid-cols-1  grid-rows-[500px_1fr] lg:grid-rows-1 lg:grid-cols-2 gap-3 max-w-[1200px] m-auto p-4">
          ...
          <div className="flex flex-col justify-start gap-6 items-start w-full text-[18px]">
            <p>Как проходит процедура у меня на приеме?</p>
            <p>
            ...
            <p>
              Сразу после введения препарата я оцениваю симметрию и форму, при необходимости внося точечные коррекции.
              Вы получаете пухлые и увлажненные губы вашей мечты. Результат держится в среднем 6-12 месяцев, в
              зависимости от препарата и метаболизма, и при необходимости может быть скорректирован или растворен.
            </p>
            ...
            <p>
              ...
              растворены с помощью фермента гиалуронидазы. Препарат подбирается индивидуально непосредственно перед
              процедурой.
            </p>
            <ButtomOpenModal>Записаться на прием</ButtomOpenModal>
          </div>
